...
ax1.axvline(7, ls=':', lw=1.8, color='tab:red')
...
ax2.plot(np.array(xs)/M, np.array(ys)/M, color='tab:red', lw=1.6,
         label=fr'Órbita ligada $r_0={r0/M:.1f}M$')
...
plt.savefig('output/figures/figura4.png', dpi=300, bbox_inches='tight')
plt.close()
